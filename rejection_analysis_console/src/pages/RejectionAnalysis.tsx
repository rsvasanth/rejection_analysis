      ...
      <div className="overflow-auto max-h-[600px]">
        <Table>
          <TableHeader>
            <TableRow className="bg-muted/50">
              <TableHead className="w-[90px] sticky top-0 bg-muted/50">Date</TableHead>
              <TableHead className="w-[90px] sticky top-0 bg-muted/50">Batch</TableHead>
              <TableHead className="w-[80px] sticky top-0 bg-muted/50">Item</TableHead>
              <TableHead className="w-[90px] sticky top-0 bg-muted/50">Mould</TableHead>
              <TableHead className="w-[90px] sticky top-0 bg-muted/50">Lot No</TableHead>
                ...
                <div className="flex items-center justify-between gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        <p className={`text-lg font-bold ${lotMetrics && (lotMetrics.patrol_rej_avg || 0) > 3 ? 'text-red-600' : 'text-green-600'}`}>
                          {lotMetrics?.patrol_rej_avg ? `${lotMetrics.patrol_rej_avg}%` : '—'}
                        </p>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        <p className={`text-lg font-bold ${lotMetrics && (lotMetrics.line_rej_avg || 0) > 3 ? 'text-red-600' : 'text-green-600'}`}>
                          {lotMetrics?.line_rej_avg ? `${lotMetrics.line_rej_avg}%` : '—'}
                        </p>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        <p className={`text-lg font-bold ${lotMetrics && lotMetrics.avg_rejection > 5 ? 'text-red-600' : 'text-green-600'}`}>
                          {lotMetrics?.avg_rejection ? `${lotMetrics.avg_rejection}%` : '—'}
                        </p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className={`text-lg font-bold ${lotMetrics && lotMetrics.lots_exceeding_threshold > 0 ? 'text-orange-600' : 'text-foreground'}`}>
